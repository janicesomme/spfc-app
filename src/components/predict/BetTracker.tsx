...
export const BetTracker = ({ totalBet, canSubmit }: BetTrackerProps) => {
  return (
    <div className="fixed top-4 right-4 z-50 bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-2 md:p-3 shadow-2xl border-2 border-black max-w-xs">
      ...
      <p className="text-xs text-white/90 mt-0.5 md:mt-1">
