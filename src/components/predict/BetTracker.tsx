...
export const BetTracker = ({ totalBet, canSubmit }: BetTrackerProps) => {
  return (
    <div className="fixed top-[calc(50vh-76px)] md:top-4 right-4 z-50 bg-blue-900 rounded-2xl px-2 pt-3 pb-2 md:px-3 md:py-2 shadow-2xl border-2 border-black max-w-xs">
