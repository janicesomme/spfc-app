...
export const BetTracker = ({ totalBet, canSubmit }: BetTrackerProps) => {
  return (
    <div className="fixed inset-x-2 bottom-4 z-20 bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-2 shadow-2xl border-2 border-black md:bottom-auto md:top-6 md:right-6 md:left-auto md:p-3 md:max-w-xs">
